...
def test_model(options):
    ...
    model = PPO.load(
        DIR_PATH + "/outputs/models/plain_ppo_seed_None_learningrate_None_evsr_1600_1800_rew_factors_1_2_3_20_1_0_20221028-110842.zip")

    # parameters for experiment run
    test_length = options.test_length

    # run model for testing
    env.set_em_veh_instertion_range(500, 1000)
